...
const Frame12 = () => {
  ...
  return (
    <View style={styles.view}>
      ...
      <View style={[styles.buttonWrapper, styles.innerLayout]}>
      ...
      >
        <View style={[styles.rectangleGroup, styles.groupPosition]}>
          ...
          <Text style={[styles.selectSomething, styles.selectTypo]}>
            select something...
          </Text>
          <Text style={[styles.selectSomething1, styles.selectTypo]}>
            select something...
          </Text>
          <Image
